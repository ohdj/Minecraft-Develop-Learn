package com.ohdj.threadplugin.executor;

import com.ohdj.threadplugin.ThreadPlugin;
import com.ohdj.threadplugin.task.Task2;
import com.ohdj.threadplugin.task.Task3;
import com.ohdj.threadplugin.task.Task4;
        ...
        if (args != null && args.length > 0) {
            ...
            switch (arg) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    /** =========== BukkitRunnable runTaskLaterAsynchronously tick时间后异步执行 =====*/
                    executeFun3(sender);
                    break;
                case "4":
                    /** =========== BukkitRunnable runTaskTimerAsynchronously 重复异步执行 =============*/
                    executeFun4(sender);
                    break;
